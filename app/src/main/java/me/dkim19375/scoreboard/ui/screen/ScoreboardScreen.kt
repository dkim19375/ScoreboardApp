package me.dkim19375.scoreboard.ui.screen
...
import me.dkim19375.scoreboard.Screen
import me.dkim19375.scoreboard.util.composable.AutoSizeText

@Composable
fun ScoreboardScreen(navController: NavHostController) = Surface(
    ...
    Box(
        ...
        Icon(
            ...
            tint = if (!isPressed) Color.White else Color.LightGray,
            modifier = Modifier
